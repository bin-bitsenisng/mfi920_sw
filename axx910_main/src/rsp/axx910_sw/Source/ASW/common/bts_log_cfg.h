...
#ifndef WIN32
#define BTS_LOG_CFG_FROM_SYS_PARAM 1
#define BTS_LOG_FREERTOS_SUPPORT_EN SYS_CONSOLE_BUFFER_EN
#define BTS_LOG_MTD_SUPPORT_EN 1
...
#define BTS_LOG_OPT_DAYTIME_EN 1
