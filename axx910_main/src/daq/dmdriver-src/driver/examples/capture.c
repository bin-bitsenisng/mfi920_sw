/************************************************************************
 ...
 | --------     ---------------------     -------------------------------
 | SYKANG       Soo-yeon Kang             bitsensing Corporation
 |-----------------------------------------------------------------------
 |              R E V I S I O N   H I S T O R Y
 |-----------------------------------------------------------------------
 | Date         Ver  Author  Description                                 
 | ----------  ----  ------  --------------------------------------------
 | 2021.01.14  0.0   sykang   Creation;
 |***********************************************************************/
...
static int radar_mode = -1;

static void write_files(const void *p, int size)
{
    int fd_buff = -1;
    int num;
    //Set file name
    time_t tm_time;
    struct tm *st_time;
    char filenanem[BUFF_SIZE];

    CLEAR(filenanem);

    time(&tm_time);
    st_time = localtime(&tm_time);
    strftime(filenanem, BUFF_SIZE, "%Y%m%d_%l%M%S.raw", st_time);
