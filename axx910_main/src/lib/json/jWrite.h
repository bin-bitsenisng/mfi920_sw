...
void jwObj_int32( char *key, int32_t value );
void jwObj_int64( char *key, int64_t value );
void jwObj_double( char *key, double value );
void jwObj_float( char *key, float value );
...
void jwArr_int32( int32_t value );
void jwArr_int64( int64_t value );
void jwArr_double( double value );
void jwArr_float( float value );
...
int jwLen( struct jWriteControl *jwc );
int jwErrorPos( struct jWriteControl *jwc );
void jwObj_string( struct jWriteControl *jwc, char *key, char *value );
void jwObj_int32( struct jWriteControl *jwc, char *key, int32_t value );
void jwObj_int64( struct jWriteControl *jwc, char *key, int64_t value );
void jwObj_double( struct jWriteControl *jwc, char *key, double value );
void jwObj_float( struct jWriteControl *jwc, char *key, float value );
...
void jwArr_int32( struct jWriteControl *jwc, int32_t value );
void jwArr_int64( struct jWriteControl *jwc, int64_t value );
void jwArr_double( struct jWriteControl *jwc, double value );
void jwArr_float( struct jWriteControl *jwc, float value );
